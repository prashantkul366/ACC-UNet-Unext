...
class UNext_CMRF_enc_CSSE(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=1,  deep_supervision=False,img_size=224, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
        ...
        self.se1 = ChannelSpatialSELayer(16)   # for t1
        self.se2 = ChannelSpatialSELayer(32)   # for t2
        self.se3 = ChannelSpatialSELayer(128)  # for t3
        self.se4 = ChannelSpatialSELayer(160)  # for t4
    ...
    def forward(self, x):
        ...
        t4 = self.se4(t4)           # Channel Spatial SE Layer
        ...
        t3 = self.se3(t3)           # Channel Spatial SE Layer
        ...
        t2 = self.se2(t2)           # Channel Spatial SE Layer   
