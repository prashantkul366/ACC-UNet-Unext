...
from .spatialmamba import SpatialMambaBlock_KAN
...
class SpatialMambaSliceBlock(nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.block = SpatialMambaBlock_KAN(hidden_dim=dim)
        print("Inside Spatial Mamba Block with KAN")
...
class SegMamba(nn.Module):
    def __init__(
        ...
        print("Initializing SegMamba with Spatial Mamba with KAN  with Deep Supervision")
