...
class SegMamba(nn.Module):
    def __init__(
        ...
        print("With Text Infusion via Skip-FiLM at encoder skip connections")
    ...
    def forward(self, x_in, text):
        ...
        enc1 = self.encoder1(x_in)
        enc1 = self.skip_film1(enc1, text_emb)
