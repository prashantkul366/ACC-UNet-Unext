...
from nets.archs.kan_r import KANLinear, KAN
...
class UNext_CMRF_GS_Wavelet_rKAN(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=1,  deep_supervision=False,img_size=224, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
        ...
        print("Rkan UNext CMRF Encoders + Global Semantic + Sematic Injection Module w Wavelet Pooling Initiated")
