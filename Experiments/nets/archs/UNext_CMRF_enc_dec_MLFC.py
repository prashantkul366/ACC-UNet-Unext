...
class UNext_CMRF_enc_dec_MLFC(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=1,  deep_supervision=False,img_size=224, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
        ...
        print("UNext CMRF Encoders + Decoder + MLFC Initiated")
        ...
        self.mlfc = MLFC(
                        in_filters1=16,  # From t1
                        in_filters2=32,  # From t2
                        in_filters3=128, # From t3
                        in_filters4=160, # From t4 after first decoder1+bn+relu
                        lenn=1           # Same as ACC-UNet
                    )
        
        # self.mlfc = MLFC(
        #                 in_filters1=80,  # From t1
        #                 in_filters2=128,  # From t2
        #                 in_filters3=160, # From t3
        #                 in_filters4=160, # From t4 after first decoder1+bn+relu
        #                 lenn=1           # Same as ACC-UNet
        #             )
        ...
        self.decoder3 = CMRF(128, 32)
        self.decoder4 = CMRF(32, 16)
        self.decoder5 = CMRF(16, 16)
    ...
    def forward(self, x):
        ...
        t1, t2, t3, t4 = self.mlfc(t1, t2, t3, t4) # MLFC FUSION
...
if __name__ == '__main__':
    ...
    model = UNext_CMRF_enc_dec_MLFC(num_classes=1, input_channels=3)
    model.eval()
