...
class UKAN(nn.Module): 
    def __init__(self, n_classes, n_channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3, embed_dims=[256, 320, 512], no_kan=False,
        ...
        self.final = nn.Conv2d(embed_dims[0]//8, n_classes, kernel_size=1)
